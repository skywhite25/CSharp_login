...
{
    public partial class CustomAppointmentForm2 : XtraForm, IDXManagerPopupMenu
    {
        ...
        public CustomAppointmentForm2()
        {
            InitializeComponent();
        }
        public CustomAppointmentForm2(SchedulerControl control, Appointment apt)
            : this(control, apt, false)
        {
        }
        public CustomAppointmentForm2(SchedulerControl control, Appointment apt, bool openRecurrenceForm)
        {
